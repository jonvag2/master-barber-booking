...
_Confirmación pendiente_`;
  ...
  const ModalityStep = () => (
    <div className="slide-up">
      ...
      <div className="grid md:grid-cols-2 gap-6 max-w-2xl mx-auto">
        {/* Barbershop Option */}
        <button
          onClick={() => setBooking({ ...booking, modality: "barbershop", address: "" })}
        ...
        {/* Home Option */}
        <button
          onClick={() => setBooking({ ...booking, modality: "home" })}
      ...
      <div className="mb-8">
        ...
        <div className="flex gap-3 overflow-x-auto pb-2 scrollbar-hide">
          {dates.map((date) => (
            <button
              key={date.full}
              onClick={() => setBooking({ ...booking, date: date.full })}
  ...
  // Steps array
  const steps = [
    { component: <LandingStep />, title: "Inicio" },
    { component: <ServiceStep />, title: "Servicio" },
    { component: <ModalityStep />, title: "Modalidad" },
    { component: <DateTimeStep />, title: "Fecha" },
    { component: <ClientDataStep />, title: "Datos" },
    { component: <ConfirmationStep />, title: "Confirmar" },
  ];
